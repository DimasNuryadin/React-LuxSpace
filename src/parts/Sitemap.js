    ...
    <div className="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
      <h5 className="text-lg font-semibold mb-2 relative">
        ...
        <button
          ...
          className={["absolute top-1/2 block md:hidden right-0 transform -translate-y-1/2 focus:outline-none transition duration-200", isActive ? "rotate-0" : "rotate-180"]}
...
export default function Sitemap() {
  ...
  return (
    <section className="sitemap">
      <div className="border-b py-12 mt-16 px-4">
