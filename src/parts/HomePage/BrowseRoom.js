...
import { formatThousand } from "helpers/format/thousand"
...
export default function BrowseRoom() {
  ...
  const ratioClassNames = {
    ...
    meta: {
      ...
      "2/2": "inset-0 md:bottom-auto left-0 top-0 bottom-0 flex justify-center md:items-center flex-col pl-48 md:pl-0 md:pt-12",
      "2/3": "inset-0 md:bottom-auto left-0 top-0 bottom-0 flex justify-center md:items-center flex-col pl-48 md:pl-0 md:pt-12"
    }
  }
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`overlay ${ratioClassNames?.meta?.[item.ratio.md]}`}>
                      ...
                      <span className="">{formatThousand(item.products)} item{item.products > 1 ? "s" : ""}</span>
                    </div>
                  </div>
                )
              })
